...
#Entry widget for tkinter
#tekstTime = tk.StringVar(value= "Input Time")
#entryTime= tk.Entry(root, width=20, textvariable= tekstTime)
#labelTime= tk.Label(root,
                         #text = "Time")
#labelTime.grid(column=0, row=1, sticky=tk.W)
#entryTime.grid(column=1, row=0, padx=10)
